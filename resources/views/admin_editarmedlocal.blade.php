...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="/admin/listarmedlocal/{{$medch->id}}" method="POST">
            ...
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <button type="button" onclick="window.location.href = '/admin/listarmedlocal';" class="btn btn-danger btn-sm">Cancelar</button>
