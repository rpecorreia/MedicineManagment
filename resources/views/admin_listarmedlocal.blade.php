            ...
            @foreach($contagem as $mc)
                <tr>
                        ...
                        @endif
                           ...
                           <td>
                                <button type="button" onclick="window.location.href ='/admin/listarmedlocal/editar/{{$mc->id}}' ;" class="btn btn-sm btn-light js-tooltip-enabled" data-toggle="tooltip" title="Editar quantidade">
                                    <i class = "fa fa-edit">
                                    </i>
                                </button>
                            </td>
