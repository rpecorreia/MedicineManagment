                            ...
                            <div class="block block-themed block-fx-shadow mb-0">
                                ...
                                <div class="block-header">
                                    ...
                                    <div class="block-options">
                                        ...
                                        <a class="btn-block-option font-size-sm" href="{{ route('admin.dashboard') }}">
                                            {{ __('Login as Admin') }}
                                        </a>
                                ...
                                <div class="block-content">
                                    <div class="p-sm-3 px-lg-4 py-lg-5">
                                        ...
                                        <p> <br> Por favor insira os seus dados de login.</p>
                                     ...
                                     <!--   <div class="form-group">
                                        ...
                                        <div class="form-group row mb-0 col-md-12 justify-content-md-center">
