            ...
            <table class = "table table-hover table-vcenter">
                ...
                @foreach($pdd as $p)
                    <tr>
                        ...
                        <form action="/admin/pedidosrecebidos/confirm/{{$p->id}}" method="POST">
                            @csrf
                        ...
                        <form action="/admin/pedidosrecebidos/reject/{{$p->id}}" method="POST">
                            @csrf
                        ...
                        <td>
                            ...
                            <td>
                                ...
                                <button type="button" onclick="window.location.href ='/admin/pedidosrecebidos/{{$p->id}}' ;" class="btn btn-sm btn-light js-tooltip-enabled" data-toggle="tooltip" title="Ver mais">
                                    Ver mais...
