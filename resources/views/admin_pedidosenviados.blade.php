            ...
            <table class = "table table-hover table-vcenter">
                ...
                @foreach($pdd as $p)
                    <tr>
                        ...
                        <form action="/admin/pedidosenviados/confirm/{{$p->id}}" method="POST">
                            @csrf
                                ...
                                <td>
                                    ...
                                    <button type="button" onclick="window.location.href ='/admin/pedidosenviados/{{$p->id}}' ;" class="btn btn-sm btn-light js-tooltip-enabled" data-toggle="tooltip" title="Ver mais">
                                        Ver mais...
